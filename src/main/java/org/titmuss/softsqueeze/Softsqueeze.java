...
public class Softsqueeze implements ConfigListener, ProtocolListener {
	...
	public void connect() {
		...
		try {
			...
			logger.info("Please wait. Connecting to Slim Server.");
			...
			logger.info("Connection failed. Please check server settings.");
